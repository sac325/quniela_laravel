...
@section('content')
@include('ajax.updatePartido')
@include('ajax.insertPartido')
...
<div class="container">
	...
	<div class="panel panel-default">
		<div class="panel-heading"><div class="row">
			...
			<div class="col-xs-4">
				<h5 class="text-center border-bottom border-gray pb-2">Grupo: {{$dt->grupo}}</h3>
				</div>
				<div class="col-xs-4">
				...
				<div class="panel-body">
					...
					<div class="row">
						...
						<div class="col-md-1 text-center"><?php echo "<img src=' " . asset("storage/upload/" . $dt->img_equipo1 ) ."'> "; ?></div>
						...
						<div class="col-md-1 text-center"><?php echo "<img src=' " . asset("storage/upload/" . $dt->img_equipo2 ) ."'> "; ?></div>
						<div class="col-md-1 text-center"></div>
    ...
    document.getElementById("prFormup").submit();
			...
			function editar(id){
				...
				$.get("{!! URL::to('partido/edit') !!}",{id:id}, function(data){
		...
		function crear(){
				...
				document.getElementById("grupo1").text='';
				...
				$.get("{!! URL::to('partido/create') !!}",null, function(data){
		...
		//		console.log(id);
				...
				$("#equipo2").append( 
					...
					.text("")
					.val(""));
				$.get("{!! URL::to('partido/selpartido') !!}",{id:id}, function(data){
			...
			//	console.log(id);
				...
				$.post("{!! URL::to('partido/destroy') !!}",{id:id}, function(data){
					$('tr#' + id).remove();
			//		console.log(data);
