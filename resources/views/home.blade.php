        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="row">
                    <div class="col-sm-4"></div>
                        <div class="col-sm-6"><h1>Fase de Grupos</h1></div>
...
<script type="text/javascript">
 ...
 onload = function(){
     ...
     $.get("{!! URL::to('home/show') !!}",null, function(data){
...
$.get("{!! URL::to('home/edit') !!}",{id:id}, function(data){
 ...
 $.each(data, function(index, item) {
   ...
   $('div#modalbody').append(
         ...
         '<div class="col-sm-1 text-center"><img  src="'+ imgequipo1 +'" ></img></div>' +
         ...
         '<div class="col-sm-3 text-center"><img  src="'+ imgequipo2 +'" ></img></div>' +
